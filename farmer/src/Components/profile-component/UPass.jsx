                ...
                <div style = {{display : "flex" , flexDirection : "row" ,  width : "100%" , height : "100%"}}>
                    <div style = {{flex : "0.7" ,   height : "70%" , display : "flex" , flexDirection : "column" , marginTop : "3%"}}>
                        <div style = {{flex : "1" , paddingLeft : "10%"}}>
                            <h6 style = {{border : "none"}}>Old Password :</h6>
                        </div>
                        <div style = {{flex : "1" , paddingLeft : "10%"}}>
                    ...
                    <div>
                        <button type="button" className = "btn btn-outline-success" style={{marginTop:"45px",marginLeft:"10px"}} onClick = {this.handleSubmit}>Change Password</button>   
                    </div>
                </div>
            </>
        )
